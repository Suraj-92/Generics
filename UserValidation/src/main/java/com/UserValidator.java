...
class UserValidator {
    ...
    UserRegistrationSystem passwordIsValidThree = (s) -> (Pattern.compile(PASSWORD3_PATTERN).matcher(s).matches());
    UserRegistrationSystem passwordIsInValidThree = (s) -> (Pattern.compile(PASSWORD3_PATTERN).matcher(s).matches());
